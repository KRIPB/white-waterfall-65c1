...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/white-waterfall-65c1)
...
3. Create a [D1 database](https://developers.cloudflare.com/d1/get-started/) with the name "billowing-field-9c9a-d1":

```bash
npx wrangler d1 create billowing-field-9c9a-d1
```
